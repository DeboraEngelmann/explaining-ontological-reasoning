...
public class OwlOntoLayer {
   ...
   public List<OWLDataProperty> getDataProperties() {
    ...
    public List<OWLLogicalAxiom> getLogicalAxioms() {
		System.out.println("getLogicalAxioms in OWLOntoLayer");
//    	Stream<OWLLogicalAxiom> logicalAxioms()
    	return new ArrayList<OWLLogicalAxiom>(this.ontology.logicalAxioms().collect(Collectors.toList()));
    }
